...
macro_rules! grid_transform_strategy_impl {
    ($Strategy:ident, $InterpDataBase:ident, $InterpDataView:ident, $N:literal) => {
        ...
        {
            /// Checks the axis count and that every raw grid coordinate is in its
            /// axis's configured transform's domain.
