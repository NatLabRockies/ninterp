...
//! ```
//! Wrap a value in [`Nested`](crate::prelude::Nested) to write the more readable nested-array
//! format:
//! ```json
//! [0.0,1.0,2.0]
//! ```
//! Reading accepts either format, so [`Nested`](crate::prelude::Nested) only affects what is
//! written.
//!
