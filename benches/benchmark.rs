...
#[allow(non_snake_case)]
/// 0D interpolation (multilinear interpolator)
...
fn benchmark_1D() {
    ...
    // Create a 1D interpolator with 100 data points
    let interp_1d =
...
#[allow(non_snake_case)]
/// 1D interpolation (multilinear interpolator)
...
#[allow(non_snake_case)]
/// 2D interpolation (multilinear interpolator)
...
#[allow(non_snake_case)]
/// 3D interpolation (multilinear interpolator)
...
pub fn criterion_benchmark(c: &mut Criterion) {
    c.bench_function("0D hardcoded", |b| b.iter(benchmark_0D));
    c.bench_function("0D multilinear", |b| b.iter(benchmark_0D_multi));

    c.bench_function("1D hardcoded (Linear)", |b| b.iter(benchmark_1D));
    c.bench_function("1D hardcoded (LinearUniform)", |b| {
        b.iter(benchmark_1D_uniform)
    });
    c.bench_function("1D multilinear (Linear)", |b| b.iter(benchmark_1D_multi));
    c.bench_function("1D multilinear (LinearUniform)", |b| {
        b.iter(benchmark_1D_multi_uniform)
    });

    c.bench_function("2D hardcoded (Linear)", |b| b.iter(benchmark_2D));
    c.bench_function("2D hardcoded (LinearUniform)", |b| {
        b.iter(benchmark_2D_uniform)
    });
    c.bench_function("2D multilinear (Linear)", |b| b.iter(benchmark_2D_multi));
    c.bench_function("2D multilinear (LinearUniform)", |b| {
        b.iter(benchmark_2D_multi_uniform)
    });

    c.bench_function("3D hardcoded (Linear)", |b| b.iter(benchmark_3D));
    c.bench_function("3D hardcoded (LinearUniform)", |b| {
        b.iter(benchmark_3D_uniform)
    });
    c.bench_function("3D multilinear (Linear)", |b| b.iter(benchmark_3D_multi));
    c.bench_function("3D multilinear (LinearUniform)", |b| {
        b.iter(benchmark_3D_multi_uniform)
    });
}
